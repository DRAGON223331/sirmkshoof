...
const WORD_BANK = [
  // أماكن
  'المطار', 'البنك', 'الشاطئ', 'الكازينو', 'الكنيسة', 'السيرك',
  'سفينة السياحة', 'السفارة', 'المستشفى', 'الفندق', 'المكتبة', 'السوق',
  'موقع التصوير', 'المتحف', 'المكتب', 'مركز الشرطة', 'السجن',
  'المطعم', 'المدرسة', 'محطة الفضاء', 'الملعب', 'الغواصة',
  'المسرح', 'محطة القطار', 'الجامعة', 'مزرعة العنب', 'حديقة الحيوان',
  'الصالة الرياضية', 'المول', 'الملاهي الترفيهية', 'الميناء', 'القلعة',
  // أشياء
  'الحقيبة السرية', 'الكاميرا', 'البوصلة', 'التنكر', 'الميكروفيلم',
  'كلمة السر', 'البيت الآمن', 'الشيفرة السرية',
  // مواقف
  'حفل زفاف', 'حفلة موسيقية', 'مباراة كرة قدم', 'مؤتمر سري',
  'حفلة تنكرية', 'رحلة مدرسية', 'احتجاج شعبي', 'عرض أزياء',
];
